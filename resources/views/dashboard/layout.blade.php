            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="{{route('list-projects')}}">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="{{route('list-projects')}}">
                                <i class="fas fa-chart-bar"></i>List Projects</a>
                        </li>
                        <li>
                            <a href="{{route('description')}}">
                                <i class="fa-solid fa-comments"></i>Widget-chat Description</a>
                        </li>                        
                        <li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('description')}}">
                                <i class="fa-solid fa-comments"></i>Chat Description</a>
                        </li>                         
                        <li>
                            <a href="{{route('api-settings')}}">
                                <i class="fas fa-table"></i>API Settings</a>
        ...
        <div class="page-container">
            ...
            <header class="header-desktop">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap float-end">
                            <!--
